...
import (
	...
	"github.com/VishDroid-dev/urlshortner-go/database"
	"github.com/VishDroid-dev/urlshortner-go/helpers"
...
func ShortenUrl(c *fiber.Ctx) error {
	...
	//Check input is actual ur

	if !govalidator.IsURL(body.URL) {
		return c.Status(fiber.StatusBadRequest).JSON(fiber.Map{"error": "Invalid URL"})
	}

	//Check for domain errror
